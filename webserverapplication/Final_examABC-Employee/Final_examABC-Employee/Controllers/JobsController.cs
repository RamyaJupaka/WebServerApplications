...
namespace Final_examABC_Employee.Controllers
{
    public class JobsController : Controller
    {
        ...
        public JobsController(ABCEmployeeJobContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var jobs = await _context.Jobs
                .FirstOrDefaultAsync(m => m.JobCode == id);
            if (jobs == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("JobCode,JobTtile,StartDate")] Jobs jobs)
        {
        ...
        {
            return _context.Jobs.Any(e => e.JobCode == id);
        }
    }
}
